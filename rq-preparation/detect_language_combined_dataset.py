...
def detect_language_combined_datasets(dataset: str):
...
if __name__ == "__main__":
    if len(sys.argv) <= 1:
        raise RuntimeError("usage : detect_language_combined_datasets.py <combined-db.sqlite>")
    detect_language_combined_datasets(sys.argv[1])
